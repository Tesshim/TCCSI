...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/singlemachineexact: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/singlemachineexact ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/_ext/4a940c2/ExactMethod.o: /home/marcelo/NetBeansProjects/SingleMachineExact/ExactMethod.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4a940c2/ExactMethod.o /home/marcelo/NetBeansProjects/SingleMachineExact/ExactMethod.cpp

${OBJECTDIR}/_ext/4a940c2/SMSP.o: /home/marcelo/NetBeansProjects/SingleMachineExact/SMSP.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/4a940c2
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4a940c2/SMSP.o /home/marcelo/NetBeansProjects/SingleMachineExact/SMSP.cpp

${OBJECTDIR}/_ext/4a940c2/SMSPSD.o: /home/marcelo/NetBeansProjects/SingleMachineExact/SMSPSD.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/4a940c2
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4a940c2/SMSPSD.o /home/marcelo/NetBeansProjects/SingleMachineExact/SMSPSD.cpp

${OBJECTDIR}/_ext/4a940c2/SMSPSDMO.o: /home/marcelo/NetBeansProjects/SingleMachineExact/SMSPSDMO.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/4a940c2
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4a940c2/SMSPSDMO.o /home/marcelo/NetBeansProjects/SingleMachineExact/SMSPSDMO.cpp

${OBJECTDIR}/_ext/4a940c2/SchedulingInstance.o: /home/marcelo/NetBeansProjects/SingleMachineExact/SchedulingInstance.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/4a940c2
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4a940c2/SchedulingInstance.o /home/marcelo/NetBeansProjects/SingleMachineExact/SchedulingInstance.cpp

${OBJECTDIR}/_ext/4a940c2/Utils.o: /home/marcelo/NetBeansProjects/SingleMachineExact/Utils.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/4a940c2
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/4a940c2/Utils.o /home/marcelo/NetBeansProjects/SingleMachineExact/Utils.cpp
